...
import { Mail, Phone, MapPin, Clock, Calendar, Download, Send, CheckCircle } from 'lucide-react';
import { insertContactSubmissionSchema, type InsertContactSubmission } from '@shared/schema';
import { useState } from 'react';

export function ContactSectionNetlify() {
  ...
  const onSubmit = async (data: InsertContactSubmission) => {
    ...
    try {
      ...
      formData.append('agreed-to-terms', data.agreedToTerms ? 'true' : 'false');
      ...
      <section className="py-20 bg-white dark:bg-slate-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-slide-up">
            ...
            <h2 className="text-4xl font-bold mb-6 text-slate-800 dark:text-slate-200">
              Thank You!
            </h2>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <Button 
                variant="outline"
                className="w-full p-4 h-auto justify-start bg-emerald-50 dark:bg-emerald-900/20 border-emerald-200 dark:border-emerald-800 hover:bg-emerald-100 dark:hover:bg-emerald-900/30"
                data-testid="button-download-portfolio"
              >
                <Download className="mr-3 h-5 w-5 text-emerald-600 dark:text-emerald-400" />
                <div className="text-left">
                  <div className="font-semibold text-emerald-600 dark:text-emerald-400">Download Portfolio</div>
              ...
              <CardContent>
                ...
                <form name="contact" data-netlify="true" data-netlify-honeypot="bot-field" hidden>
                  ...
                  <select name="project-type">
                    ...
                    <option value="model-training">Model Training & Fine-tuning</option>
                  ...
                  <input type="checkbox" name="agreed-to-terms" />
                </form>
