        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.div variants={itemVariants}>
              <Badge className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-300 dark:border-blue-700 text-white dark:text-blue-100 text-sm font-medium">
